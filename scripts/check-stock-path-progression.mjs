...
const rows = [sample(1, 1), sample(1, 2), sample(1, 7), sample(2, 7), sample(3, 1)]
const [week1Day1, week1Day2, week1Day7, week2Day7, week3Day1] = rows

assert(week1Day1.factor < week1Day2.factor && week1Day2.factor < week1Day7.factor, '1주차 경로 강도가 날짜에 따라 증가하지 않습니다.')
...
assert(week1Day1.move < week1Day7.move && week1Day7.move < week3Day1.move, '실측 구간 변동이 의도한 순서로 증가하지 않습니다.')
