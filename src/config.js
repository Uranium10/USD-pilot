...
export const MINE_BASE_COST = 400
export const MINE_COST_GROWTH = 1.22
...
export const INITIAL_DEBT = 58000 // 6주기에 걸쳐 갚을 전체 원금(총 부채 시작값)
export const INTEREST_RATE = 0.24 // 매 주기, 남은 총 부채에 붙는 이자율
export const DEBT_RATIO = 0.14 // 최소 상환액 중 "남은 부채 비례분" 비율
// 상승 하한(최소 상환액의 바닥값)을 주기별로 직접 지정한 계단형 곡선.
// 앞 3주는 완만하게(+1,500), 뒤 3주는 급격하게(+6,000~7,000) 조여온다 — 실측 밸런싱 결과.
export const FLOOR_BY_CYCLE = [9000, 10500, 12000, 18000, 24000, 31000]
