...
const headlines = {
  ...
  down: [
    ...
    '외곽 식민지 정전 사태로 서버 데이터 대량 유실',
    '우주 해적의 물류선 약탈 피해... 보안 시스템 구멍 논란',
...
const rumorSources = ['익명 해커의 데이터랩', '뒷골목 정보상', '고위 임원의 비서', '블랙마켓 찌라시', '궤도 관제소 첩보', '퇴사한 수석 엔지니어', '심우주 탐사선 통신 감청', '사설탐정 사무소 보고서', '어둠의 다크웹 포럼', '외곽 행성계 밀수업자']
...
const rumorEvents = [
  ...
  {
    up: ['저중력 골손실 치료제 임상시험 유의미한 결과 도출', '장기 동면용 세포 안정제 긴급 사용 승인 신청', '수명 연장 텔로미어 활성화 물질 특허 획득', '외계 생물학 기반 신종 바이러스 백신 개발 선두'],
    down: ['주력 배양 장기에서 원인 불명 치명적 변이 발견', '임상 데이터 조작 주장하는 내부 고발 문서 온라인 유포', '신약 부작용으로 인한 임상 참가자 집단 소송 위기', '연구소 내 생물재해 발생으로 시설 전면 폐쇄'],
  },
  {
    up: ['외곽 식민지 방위체계 교체 사업 단독 공급자 지명', '신형 요격 드론 실전 모의시험 목표 100% 격추', '차세대 전자기 펄스 무기 양산 체제 돌입', '우주 연합군 대규모 무기 체계 업그레이드 수주'],
    down: ['신형 요격 드론 민간 위성 오인 추적 사실 은폐 논란', '전쟁범죄 조사위원회 무기 수출 기록 강제 제출 명령', '무기 제어 소프트웨어 해킹으로 시제품 탈취 발생', '핵심 폭발물 원료 공급처 화재로 생산 차질'],
  },
  {
    up: ['수성 궤도 태양광 집광망 첫 상업 송전 대성공', '노후 핵융합 발전소 대체할 장기 전력 계약 체결', '무선 전력 전송 거리 기록 2배 이상 경신', '초고효율 반물질 반응로 소형화 성공 임박'],
    down: ['집광 위성군 냉각 장치 결함으로 송전 효율 급락', '에너지 규제국 독점 요금 산정 방식 강도 높은 조사', '주력 발전소 원인 불명 셧다운으로 대규모 정전 유발', '불법 에너지 탈취꾼들에 의한 송전망 심각한 손상'],
  },
  {
    up: ['라그랑주 항로 긴급 화물 운송권 단독 확보', '무인 화물선 회항 시간 절반 단축 관제 체계 공개', '양자 텔레포테이션 기반 소화물 전송 기술 시연', '대규모 우주 해적 소탕 작전 지원으로 신뢰도 급상승'],
    down: ['주력 화물선단 항법 오류로 소행성대 발 묶여', '밀수 화물 은폐 의혹 주요 우주항 운항 허가 정지', '초대형 화물선 엔진 폭발로 적재물 전량 손실', '화물 터미널 파업 장기화로 운송 지연 배상금 눈덩이'],
  },
  {
    up: ['외곽 식민지용 양자 통신 중계망 구축 사업 수주', '태양폭풍 속 연결 유지 신규 프로토콜 완벽 검증', '은하 간 초공간 통신 딜레이 0.1초 미만 달성', '경쟁사 대비 10배 빠른 위성 인터넷 상용화 예고'],
    down: ['통신 중계 위성 대규모 개인정보 유출 흔적 발견', '경쟁사 무료 통신망 개방 유료 가입자 대거 이탈', '통신 암호화 키 해킹으로 주요 정부 기관 데이터 노출', '통신 위성 궤도 이탈로 서비스 권역 블랙아웃'],
  },
  {
    up: ['화성 농업 돔 장기 배양식 공급 독점 계약 체결', '저중력 환경 식감 유지 단백질 배양 기술 공개', '완전 합성 유기농 식단 우주 비행사 표준 식량 채택', '신개념 우주 수경재배법으로 수확량 500% 증가'],
  ...
  {
    up: ['토성 고리 전망 최고급 호텔 예약 개장 전 매진', '무중력 레저 복합 시설 국제 안전 인증 최고 등급 획득', '초호화 우주 크루즈 첫 항해 성황리에 마무리', '가상현실 결합한 신개념 우주 관광 패키지 대히트'],
    down: ['관광 셔틀 산소 공급 사고 전 노선 운항 무기한 중단', '고가 패키지 환불 사태 발발 단기 유동성 위기', '우주 리조트 내 전염병 창궐로 2주간 전면 봉쇄', '소행성 충돌 위험으로 주요 관광 루트 폐쇄 조치'],
  },
  {
    up: ['차세대 항법 칩 수율 90% 달성... 대량 납품 시작', '극저온 양자 프로세서 기존 최고 연산 기록 경신', '인공지능 특화 뉴로모픽 반도체 상용화 앞당겨', '은하계 최대 전자기기 제조사와 독점 공급 계약'],
