...
export const SCENES = {
  'prologue-day1': {
    ...
    lines: [
      ...
      { speaker: 'system', text: '귀하의 모친과 부친이 회사에 끼친 손실, 그리고 사내 규정에 의거- 모든 배상 책임은 귀하에게 채무 형태로 상속되었습니다.' },
      ...
      { speaker: 'system', text: '사내 규정에 의거, 미상환 시 시지프 인텔리전스 **내부 연구직**으로 특별 채용 기회가 주어지니, 부디 긍정적으로 검토하시길 바랍니다.' },
