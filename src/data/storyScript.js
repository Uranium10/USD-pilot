...
export const SCENES = {
  'prologue-day1': {
    ...
    lines: [
      ...
      { speaker: 'tarae', portrait: 'neutral', text: '새벽 알림은 둘 중 하나지. 스팸이거나, 스팸보다 나쁜 현실이거나.' },
      { speaker: 'system', text: '[시지프 인텔리전스 채권관리부]\n상속 집행이 정상적으로 완료되었습니다.' },
      { speaker: 'tarae', portrait: 'worried', text: '잠깐. 부모님은 **실종**이야. 어디선가 살아 있을지도 모르는데, 무슨 상속을—' },
      { speaker: 'system', text: '귀하의 이의 제기는 접수와 동시에 기각되었습니다. 빠른 행정 처리에 협조해 주셔서 감사합니다.' },
      { speaker: 'tarae', portrait: 'worried', text: '사람 걱정은 1초도 안 하면서 일 처리는 광속이네. 진짜 눈물 나게 고맙다.' },
      ...
      { speaker: 'tarae', portrait: 'worried', text: '뇌를 서버에 꽂고 영원히 갈아버리는 걸 **복지**라고 쓰면 복지가 되는 거야?' },
      { speaker: 'system', text: '상환 기한: **6주.**\n현재 채무: **₡{{debt}}.**\n현재 가용 현금: **₡{{cash}}.**' },
      { speaker: 'tarae', portrait: 'worried', text: '......이 정도면 망한 인생 게시판에서도 주작이라고 욕먹겠다.' },
      { speaker: 'tarae', portrait: 'worried', text: '잠깐만 울고 싶지만, 울기에도 6주는 너무 짧네.' },
      ...
      { speaker: 'tarae', portrait: 'worried', text: '그래도 내가 끌려가 버리면... 부모님을 계속 찾을 사람도 없어.' },
      { speaker: 'tarae', portrait: 'determined', text: '무섭지만 해보자. **빚을 갚고, 살아남고, 부모님을 찾는 거야.**' },
      { speaker: 'tarae', portrait: 'determined', text: '그리고 가능하다면... 나 같은 통지서를 받는 사람이 더는 없게 만들자.' },
    ],
  },
}
