...
export const ENDING_TEMPLATES = {
  bad: {
    ...
    lines: [
      { background: ENDING_BACKGROUNDS.interior, speaker: 'system', text: '00:00. 장 마감 알림이 사라진 자리에 새 창 하나가 떠올랐다.' },
  ...
  normal: {
    ...
    lines: [
      { background: ENDING_BACKGROUNDS.interior, speaker: 'system', text: '송금 버튼을 누른 뒤에도 한동안 아무 일도 일어나지 않았다.' },
      ...
      { background: ENDING_BACKGROUNDS.exterior, speaker: 'system', text: '오랜만에 연 방문 너머로 궤도 도시의 아침 소음이 밀려들었다.' },
  ...
  hidden: {
    ...
    lines: [
      { background: ENDING_BACKGROUNDS.exterior, speaker: 'system', text: '[궤도거래소 긴급 공시]\n시지프 인텔리전스의 최대 주주가 변경되었습니다.' },
      ...
      { background: ENDING_BACKGROUNDS.interior, speaker: 'system', text: '[임시 주주총회 결의]\n대표이사 해임. METIS 코어 접근 권한을 신규 최대 주주에게 이관합니다.' },
  ...
  true: {
    ...
    lines: [
      { background: ENDING_BACKGROUNDS.interior, speaker: 'system', text: '밀항선의 화물칸은 방보다 좁았고, 가진 것을 거의 다 털어 산 좌석은 볼트 두 개뿐이었다.' },
      { speaker: 'tarae', text: '표 한 장에 가진 걸 거의 다 썼네. 그래도 저 창문 없는 방보단 훨씬 넓어 보여.' },
      { background: ENDING_BACKGROUNDS.exterior, speaker: 'system', text: '도킹 해제. 궤도 관제국의 정지 명령이 잡음 속으로 멀어진다.' },
