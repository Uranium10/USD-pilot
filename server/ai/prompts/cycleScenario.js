...
- headline은 실제 기업명과 구체적인 주체·행동·결과가 있는 짧은 한 문장으로 쓴다. 전광판용 명사구가 아니라 조사와 서술어를 갖춘 완결문이어야 한다.
- headline에서 '논란 확산', '소송 예고', '자료 제출 준비'처럼 명사를 이어 붙여 끝내지 말고 '논란이 확산됐다', '소송을 예고했다', '자료를 제출하기로 했다'처럼 누가 무엇을 했는지 쓴다.
- 공문·계약·의학 용어를 임의의 합성어로 압축하지 말고 한국어 기사에서 자연스럽게 읽히는 표현을 쓴다. 서로 다른 행정 조치를 한 문장에 억지로 연결하지 않는다.
- rumorSeeds.angle은 정보원이 포착한 구체적인 사실과 예상 영향을 1~2문장으로 쓴다.
- rumorSeeds.angle의 첫 문장은 포착한 사실을, 마지막 문장은 targetEventId 사건의 대상 기업명과 그 기업에 생길 구체적인 결과를 쓴다. 코드가 문장을 보충하지 않아도 원문만으로 대상과 주가 방향을 이해할 수 있어야 한다.
- 기업·제품 같은 구체적 대상을 절차·신뢰도·시장 같은 추상 개념과 'A보다 B가 먼저 흔들린다'는 식으로 비교하지 말고, 사실 → 기업의 수주·매출·비용·일정 변화 순서로 인과를 직접 설명한다.
- 예상 영향 문장에는 대상 기업 하나만 주어로 두고 다른 기업과 우선순위나 피해 정도를 비교하지 않는다.
